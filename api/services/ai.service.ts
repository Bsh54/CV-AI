...
const AI_API_URL = process.env.VITE_AI_API_URL;
...
export async function optimizeCVWithAI({
  ...
  try {
    ...
    // Réparation du JSON si nécessaire
    ...
    // En cas d'erreur, on retourne les données originales
    console.warn("Falling back to original CV data without optimization");
    return currentData;
  }
}
